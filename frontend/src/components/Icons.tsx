...
const defaultProps: IconProps = { size: 24, color: "currentColor" };
...
export function BrainIcon({ size = 24, color = "currentColor", className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
      <path d="M9.5 2A5.5 5.5 0 0 0 4 7.5c0 1.28.44 2.46 1.17 3.39A4.5 4.5 0 0 0 3 14.5 4.5 4.5 0 0 0 7.5 19h.5v3h8v-3h.5a4.5 4.5 0 0 0 4.5-4.5c0-1.42-.66-2.69-1.69-3.51A5.5 5.5 0 0 0 14.5 2h-5z" />
      <path d="M12 2v20" />
    </svg>
  );
}
...
export function FlagIcon({ size = 24, color = "currentColor", className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
// Mode icons (colored circles with inner icons)
export function FlagModeIcon({ size = 20, className }: IconProps) {
  return (
...
export function WarnModeIcon({ size = 20, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" className={className}>
...
export function RedactModeIcon({ size = 20, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" className={className}>
...
export function PolicyModeIcon({ size = 20, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" className={className}>
      <circle cx="12" cy="12" r="10" fill="#64748b" opacity="0.2" />
      <circle cx="12" cy="12" r="5" fill="#475569" />
    </svg>
  );
}
...
export function BarChartIcon({ size = 24, color = "currentColor", className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
